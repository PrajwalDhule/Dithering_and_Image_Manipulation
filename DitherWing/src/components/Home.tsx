    ...
    <>
      <div className="w-[92.5vw] lg:flex justify-between items-start">
          ...
          <div className="flex flex-col gap-0 mb-6">
            <div className="flex justify-between items-center text-white text-base font-medium segment-title">
              ...
              >
                <ArrowUpSvg
                  className={
                    collapsedSections.inputImage ? "arrow-collapsed" : ""
                  }
                />
              </button>
            </div>
            {!collapsedSections.inputImage && (
            ...
            <div className="flex justify-between items-center mt-4 text-white text-base font-medium segment-title">
              <h3>Main settings</h3>
              <button
                className="bg-transparent"
              ...
              >
                <ArrowUpSvg
                  className={
                    collapsedSections.mainSettings ? "arrow-collapsed" : ""
                  }
                />
              </button>
            </div>
            ...
            <div className="flex justify-between items-center mt-4 text-white text-base font-medium segment-title">
              ...
              >
                <ArrowUpSvg
                  className={
                    collapsedSections.moreFilters ? "arrow-collapsed" : ""
                  }
                />
              </button>
            </div>
        ...
        <div className="mt-8">
          ...
          <div className="flex justify-end items-start gap-8 h-[80vh] lg:w-[60vw] mt-12">
            <div
              className={`${
                isImageZoomMode
                  ? "w-auto h-auto max-w-[36vw] aspect-square"
                  : "w-[45%] h-full"
              } relative`}
            >
              ...
              <div
                className={`${
                  isImageZoomMode ? "overflow-auto" : ""
                } h-full w-full`}
              >
                <canvas
                  className={`${
                    isImageZoomMode
                      ? "min-w-[50vw] min-h-[50vw]"
            ...
            <canvas className="hidden" ref={inputCanvasRef} />
            <div className={`${isImageZoomMode ? "" : "h-full"} relative`}>
              <h3 className="absolute top-0 left-0 -translate-y-[150%] z-10 overflow-visible">
                Input image
              </h3>
              {originalImage?.src && (
                <img
                  className={`${
                    isImageZoomMode
                      ...
                      : "lg:max-w-[27vw] h-auto max-h-full"
                  } object-contain`}
                  // "max-w-[36vw] max-h-full object-contain"
                  src={originalImage.src}
                  alt="Uploaded Image"
                />
              )}
